...
<title>Admin Complain detail View</title>
</head>
<body>
		...
		<div>
		    ...
		    <div class="post add">
		        <form id="update" action="${pageContext.servletContext.contextPath}/login/admin/complainRE" method="post">
		            ...
		            <textarea name="content" id="adminCPcontent" cols="30" rows="10" style="resize: none;" minlength="3" required><c:out value="${ requestScope.detailComplain.answerContent }" escapeXml="true"/></textarea><br>
		            <c:choose>
