...
//	HITS	NUMBER
	...
	public QnaDTO(int num, int cateNum, String memId, String managerId, Date postDate, String title, String content,
			String answerYn, String answerContent, String displayYn, int hits) {
		super();
		this.num = num;
	...
	public String toString() {
		return "QnaDTO [num=" + num + ", cateNum=" + cateNum + ", memId=" + memId + ", managerId=" + managerId
