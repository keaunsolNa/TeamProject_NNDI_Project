...
public class ComplainAndCategoryDTO {
...
//	HITS	NUMBER
	...
	public ComplainAndCategoryDTO() {
		super();
	}
	public ComplainAndCategoryDTO(int num, int cateNum, String memId, String managerId, Date postDate, String title,
	...
	public String toString() {
		return "ComplainAndCategoryDTO [num=" + num + ", cateNum=" + cateNum + ", memId=" + memId + ", managerId="
